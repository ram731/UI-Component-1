...
@Component({
    ...
    <mfPaginator #p [mfTable]="mfTable">
        <ul class="pagination float-left mb-0" *ngIf="p.dataLength > p.rowsOnPage">
            ...
            <li *ngIf="p.lastPage > 1" class="page-item" (click)="p.setPage(p.lastPage)">
            ...
            <li class="page-item" [class.disabled]="p.activePage <= 1" (click)="p.setPage(p.activePage - 1)">
                <a class="page-link direction" style="cursor: pointer"><i class="fa fa-chevron-left"></i></a>
            </li>
            <li class="page-item" [class.disabled]="p.activePage >= p.lastPage" (click)="p.setPage(p.activePage + 1)">
                <a class="page-link direction" style="cursor: pointer"><i class="fa fa-chevron-right"></i></a>
            </li>
        </ul>
